...
public class Window : Game
{
    ...
    {   
        ...
        this.canvas.Draw();
        spriteBatch.Draw(whitePixelTexture, new Rectangle(0, 0, Window.ClientBounds.Size.X, 70), new Color(230, 230, 230, 255));
        ...
        this.top.DrawPath(this.spriteBatch, this.fontSystem.GetFont(25));
